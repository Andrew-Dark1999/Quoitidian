(function() {
  ...
  Morris.Grid = (function(_super) {
    ...
    Grid.prototype.yLabelFormat = function(label) {
      if (typeof this.options.yLabelFormat === 'function') {
        ...
        if (Reports.graph_data[this.options.element].other_params.suffix[this.options.ykeys] == 'percent') {
  ...
  Morris.Line = (function(_super) {
    ...
    Line.prototype.displayHoverForRow = function(index) {
      ...
      if (index != null) {
        ...
        this.hover.el.find('.triangle').css('left',this.data[index]._x-parseInt(this.hover.el.css('left'))+'px');
        if (this.data[index]._y<parseInt(this.hover.el.css('top'))) {
          this.hover.el.find('.triangle').addClass('top');
        }
    ...
    Line.prototype.hoverContentForRow = function(index) {
      ...
      for (j = _i = 0, _len = _ref.length; _i < _len; j = ++_i) {
        y = _ref[j];
        content += "<div class='morris-hover-point'><div class='morris-hover-dot' style='background-color: " + (this.colorFor(row, j, 'label')) + "'>\n</div>  " + this.options.labels[j] + ":\n  <b>" + (this.yLabelFormat(y)) + "</b>\n</div><div class='triangle'></div>";
      }
      if (typeof this.options.hoverCallback === 'function') {
        content = this.options.hoverCallback(index, this.options, content);
      }
      if (row._y[0]<row._y[1]) {
        row._ymax = row._y[0];
      } else if (row._y[1]<row._y[0]) {
        row._ymax = row._y[1];
      }
    ...
    Line.prototype.draw = function() {
      if (this.options.axes) {
        ...
        var textdebug; 
        var $prevtext; 
        this.el.find('tspan').each(function(){
            if (textdebug == $(this).html()) {
                $prevtext.remove();
            }; 
            textdebug = $(this).html();
            $prevtext = $(this);
  ...
  Morris.LABEL_SPECS = {
    ...
    "quarter": {
      span: 7257600000,
      start: function(d) {
        return new Date(d.getFullYear(), d.getMonth() - d.getMonth() % 10, 0, 1);
      },
      fmt: function(d) {
        return "" + (d.getFullYear()) + "-" + (Morris.pad2(d.getMonth()*2 + 1));
      },
      incr: function(d) {
  ...
  Morris.AUTO_LABEL_ORDER = ["decade", "year", "quarter", "month", "day", "hour", "30min", "15min", "10min", "5min", "minute", "30sec", "15sec", "10sec", "5sec", "second"];
  ...
  Morris.Bar = (function(_super) {
    ...
    Bar.prototype.drawBar = function(xPos, yPos, width, height, barColor) {
      return this.raphael.rect(xPos, yPos, width, height).attr('fill', barColor).attr('fill-opacity', '0.5').attr('stroke-width', 0);
    };
  ...
  Morris.Donut = (function(_super) {
    ...
    Donut.prototype.redraw = function() {
      ...
      this.text1 = this.drawEmptyDonutLabel(cx, cy + 25, this.options.labelColor, 14, 400);
      this.text2 = this.drawEmptyDonutLabel(cx, cy - 15, this.options.labelColor, 36);
