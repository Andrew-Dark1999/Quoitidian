    ...
    <div class="list-view-panel content-panel">
        <section class="panel">
            <header class="panel-heading">
                <?php echo Yii::t('PermissionModule.base', 'Roles');; ?>
                ...
                <div class="adv-table editable-table">
                    <div class="btn-section clearfix">
                        ...
                        if (
                            ...
                            ?>
                            <div class="btn-group">
                                <button class="btn btn-primary <?php echo $dnt_card_add_class; ?> "><?php echo Yii::t('base', 'Add'); ?> +</button>
                            </div>
                            <?php
                        }
                            ...
                            if (ControllerModel::inContentBlock(ControllerModel::CONTENT_BLOCK_3)) {
                                ...
                                >
                                    ...
                                    <tr>
                                            ...
                                            foreach ($params['header'] as $value) {
                                               ...
                                               "
                                                    ...
                                                    <span class="table-handle"
                                                        ...
                                                        } ?>"><?php echo Yii::t('RolesModule.base', $value['title']); ?></span>
                                        ...
                                        ?>
                                        <th id="order-<?php echo $extension_copy->copy_id . '_' . ++$order; ?>"
                                            class="sorting <?php if (Sorting::getInstance()->fieldExists(null, 'date_create')) {
                                                echo 'sorting_' . Sorting::$params['date_create'];
                                            } ?>"
                                            data-name="date_create"
                                        >
                                            <span class="sorting-arrows"></span><?php echo Yii::t('RolesModule.base', 'Date create'); ?>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    foreach ($submodule_data as $value_data) {
                                        ...
                                        >
                                            ...
                                            ?>
                                            <td>
                                                <span></span><?php echo Helper::formatDateTime($value_data['date_create']); ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
