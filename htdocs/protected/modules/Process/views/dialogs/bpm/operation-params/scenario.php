<?php  $last_execute_status = $operation_model->getLastExecuteStatus(); ?>
...
<script>
    ...
    <?php if($last_execute_status['status'] == false){
        $m = $last_execute_status['validate']->getValidateResultHtml();
    ?>
        setTimeout(function(){
