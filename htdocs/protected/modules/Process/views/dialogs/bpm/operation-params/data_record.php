    ...
    >
        ...
        <div class="panel-body">
            ...
            <div class="buttons-section">
                <button type="button" class="btn btn-primary element" data-type="save" <?php //echo ($operations_model->getMode() == \Process\models\OperationsModel::MODE_CONSTRUCTOR ? '' : 'disabled'); ?>><?php echo Yii::t('base', 'Save')?></button>
