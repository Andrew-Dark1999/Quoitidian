<?php $unique_index = (isset($_POST['unique_index']) ? $_POST['unique_index'] : md5(date('YmdHisu'))); ?>
    ...
    >
        ...
        <header class="panel-heading editable-block hidden-edit">
            <?php
                ...
                $new_record_title = $edit_view_action_model->getEditModel()->getDefaultModuleTitle();
        	...
        	<span class="tools options">
                <?php if($btn_action_list){ ?>
                    <span class="edit-dropdown crm-dropdown dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php foreach($btn_action_list as $key => $action){ ?>
                                <li><a href="javascript:void(0)" class="edit_view_btn-<?php echo $key; ?>"><?php echo Yii::t('base', $action['title']); ?></a></li>
                            <?php } ?>
                        </ul>
                    </span>
                <?php } ?>
